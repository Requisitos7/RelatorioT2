\section{Definições de Requisitos Ágeis}
	...
	A rastreabilidade vertical é utilizada para identificar a origem dos requisitos e está presente nas relações de um nível de abstração e outro.\\
		...
		\begin{figure}[!htp]
			...
			\caption{Rastreabilidade vertical de \textit{features} e histórias de usuário 1.}
			\label{imagem}
		\end{figure}
		...
		\begin{figure}[!htp]
			...
			\caption{Rastreabilidade vertical de \textit{features} e histórias de usuário 2.}
			\label{imagem}
		\end{figure}
		...
		\begin{figure}[!htp]
			...
			\caption{Rastreabilidade vertical de \textit{features} e histórias de usuário 3.}
			\label{imagem}
		\end{figure}
